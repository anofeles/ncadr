                        ...
                        <div class="card-body">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-app"
                                           href="{{route('admin.biblioteka.add', ['locale' => $locale])}}">
                                        ...
                                        <table id="example2"
                                            ...
                                            @foreach($books as $booksitem)
                                                <tr role="row" class="odd">
                                                    <td class="dtr-control sorting_1"
                                                        tabindex="0">{{$booksitem->bookId}}</td>
                                                    <td>{{$booksitem->title}}</td>
                                                    <td>{{$booksitem->author}}</td>
                                                    <td>{{$booksitem->pub_year}}</td>
                                                    <td>
                                                        <a class="btn btn-app"
                                                           href="{{route('admin.edit.biblioteka', ['postid'=>$booksitem->bookId,'locale' => $locale])}}">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        <a class="btn btn-app"
                                                           href="{{route('admin.delete.biblioteka', ['postid'=>$booksitem->bookId,'locale' => $locale])}}">
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1">ავტორი</th>
