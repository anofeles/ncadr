                        ...
                        <div class="card-body">
                            <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <a class="btn btn-app"
                                           href="{{route('admin.biblioteka.lamguage.add', ['locale' => $locale])}}">
                                            ...
                                            @foreach($language as $languageitem)
                                                <tr role="row" class="odd">
                                                    <td class="dtr-control sorting_1"
                                                        tabindex="0">{{$languageitem->langId}}</td>
                                                    <td>{{$languageitem->langName}}</td>
                                                    <td>
                                                        <a class="btn btn-app"
                                                           href="{{route('admin.edit.biblioteka.lamguage', ['postid'=>$languageitem->langId,'locale' => $locale])}}">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        <a class="btn btn-app"
                                                           href="{{route('admin.delete.biblioteka.lamguage', ['postid'=>$languageitem->langId,'locale' => $locale])}}">
