                                        ...
                                        <table id="example2"
                                            ...
                                            @foreach($post as $postitem)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-app" href="{{route('admin.galeri.edit', ['postid'=>$postitem->id,'locale' => $locale])}}">
                                                            <i class="fas fa-edit"></i> Edit
                                                        </a>
                                                        <a class="btn btn-app" href="{{route('admin.galeri.delete', ['postid'=>$postitem->id,'locale' => $locale])}}">
